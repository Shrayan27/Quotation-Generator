...
exports.generateQuotationHtml = generateQuotationHtml;
const formatters_1 = require("../utils/formatters");
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const logoPath = path_1.default.join(process.cwd(), "kb_logo.png");
let kbLogoBase64 = "";
try {
    const logoBuffer = fs_1.default.readFileSync(logoPath);
    kbLogoBase64 = `data:image/png;base64,${logoBuffer.toString("base64")}`;
}
catch (e) {
...
function generateQuotationHtml(q) {
    ...
    const totalWords = (0, formatters_1.numberToWords)(total);
    const freightLabel = q.freightType === "extra"
        ? "EXTRA"
        : q.freightType === "custom"
            ? (0, formatters_1.formatRupees)(q.freightAmt || 0)
            : "Included";
    const instLabel = q.instType === "extra" ? "EXTRA" : "Included";
    const headerBrandingHtml = kbLogoBase64
        ? `<img src="${kbLogoBase64}" style="max-height:100px;max-width:200px;object-fit:contain;display:block;" alt="Company Logo" />`
        : `
    <div style="display:flex;align-items:center;gap:8px;">
      <div style="background:#fff;color:#2c2a28;font-weight:900;font-size:18px;
      ...
      <div>
        ...
        <div style="font-size:11px;opacity:0.85;color:#e0e0e0;">sensormart.co.in</div>
      </div>
    </div>`;
    const headerBarHtml = `
    <!-- Top Brand Header -->
    <div class="header-bar">
      ...
      <div style="background:#fff;color:#2c2a28;padding:12px calc(20px + 8mm) 8px 45px;width:max-content;flex-shrink:0;box-sizing:border-box;clip-path:polygon(40px 0, 100% 0, 100% 100%, 0 100%);font-size:10px;font-weight:700;position:relative;">
        <div style="position:absolute;top:0;left:38px;right:0px;height:5px;background:#facc04;"></div>
        <div style="display:flex; justify-content:flex-end; align-items:center; gap:12px; flex-wrap:nowrap; white-space:nowrap;">
          <div style="display:flex; align-items:center; gap:6px;">
            <div style="background:#facc04;width:18px;height:18px;border-radius:50%;display:flex;align-items:center;justify-content:center;color:#2c2a28;">
    ...
    const taxBlockHtml = q.taxType === "igst"
       ...
       <div style="display:flex;justify-content:space-between;padding:3px 0;font-size:11px;"><span>IGST:</span>
         <span style="color:#b30000;font-weight:700;">${(0, formatters_1.formatRupees)(taxSum)}</span></div>`
        : `<div style="display:flex;justify-content:space-between;padding:3px 0;font-size:11px;"><span>CGST:</span>
         <span>${(0, formatters_1.formatRupees)(taxSum / 2)}</span></div>
          ...
          <td colspan="${q.isDocComposite ? 4 : 6}" style="border:none; padding:0; vertical-align:top;">
            ...
            <div class="grid-4 bordered" style="font-size:11px;">
              ...
              <div style="padding:6px 10px;border-right:1px solid #ccc;">
                ...
                <span style="color:#111;">${(0, formatters_1.formatDate)(q.quoteDate)}</span>
              </div>
              <div style="padding:6px 10px;border-right:1px solid #ccc;">
              ...
              <div style="padding:6px 10px;">
                ...
                <span style="color:#111;">${q.validTill ? (0, formatters_1.formatDate)(q.validTill) : "30 days"}</span>
              </div>
            </div>
            ...
            <div class="grid-2 bordered" style="font-size:11px;">
              ...
              <div style="padding:6px 10px;">
                ...
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <span style="font-weight:800;color:#555;">Payment Terms:</span> <strong style="color:#111;">${q.payTerms || "100% Advance"}</strong>
              </div>
            </div>
            ...
            <div class="grid-2 bordered" style="font-size:12px; border-top: 1px solid #ccc; page-break-inside: avoid; break-inside: avoid;">
              ...
              <div style="padding:10px 14px;">
                ...
                <div style="display:flex;justify-content:space-between;border-top:1px solid #ddd;padding-top:5px;margin-top:5px;font-size:11px;">
                  ...
                  <strong style="color:#111;font-size:12px;">${(0, formatters_1.formatRupees)(sub)}</strong>
                </div>
            ...
            <div class="grid-2 bordered" style="font-size:11px; page-break-inside: avoid; break-inside: avoid;">
              ...
              <div style="padding:8px 12px;display:flex;justify-content:space-between;align-items:center;background:#fcfdfc;">
                ...
                <div style="font-size:18px;font-weight:900;color:#1a3a1a;">
                  ${(0, formatters_1.formatRupees)(total)}
                </div>
              </div>
            </div>
