...
export const QuotationEditor: React.FC = () => {
  ...
  const handleGlobalPhotoUpload = (field: 'companyLogo' | 'authSignature', file: File | null) => {
    if (!file) return;
    const reader = new FileReader();
    reader.onload = (e) => {
      const result = e.target?.result as string;
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      ...
      state.setToast(error.message || 'Error executing dynamic PDF stream mapping.', 'warn');
    } finally {
  ...
  const handleSaveToHistory = async () => {
    if (!state.billName.trim()) {
      state.setToast('Please input a valid Customer Billing Company Name first.', 'warn');
      return;
    }
    ...
    try {
      ...
      // Save notification item locally for follow-up tracker triggers
      const notifsRaw = localStorage.getItem('kb_notifications') || '[]';
      const notifsArr = JSON.parse(notifsRaw);

      const due = new Date();
      due.setDate(due.getDate() + state.notificationDays);
      ...
      try {
        const legacyHist = JSON.parse(localStorage.getItem('kb_history') || '[]');
        legacyHist.unshift({
          id: String(Date.now()),
          quoteNo: state.quoteNumber,
          custName: state.billName,
        ...
        // Save mock notification item locally for tracker triggers
        const notifsRaw = localStorage.getItem('kb_notifications') || '[]';
        const notifsArr = JSON.parse(notifsRaw);
        const due = new Date();
        due.setDate(due.getDate() + state.notificationDays);
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="p-1.5 bg-gray-200/80 rounded-xl flex items-center gap-1 max-w-md mx-auto">
          <button
            ...
            className={`flex-1 py-2 rounded-lg font-extrabold text-xs transition-all flex items-center justify-center gap-2 ${activeTab === 'edit'
          ...
          <button
            ...
            className={`flex-1 py-2 rounded-lg font-extrabold text-xs transition-all flex items-center justify-center gap-2 ${activeTab === 'preview'
        ...
        {activeTab === 'preview' ? (
          <div className="bg-white rounded-2xl border border-gray-200 p-2 shadow-sm animate-fadeIn">
            <div className="px-4 py-2 bg-gray-50 border-b border-gray-100 flex items-center justify-between rounded-t-xl mb-2">
              <span className="text-xs font-bold text-gray-500">Live Handlebars A4 Preview Stream</span>
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="p-6 rounded-2xl bg-white border border-gray-200 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Quote Reference Number</label>
                  <input
                    type="text"
                    value={state.quoteNumber}
                    onChange={(e) => handleTextChange('quoteNumber', e.target.value)}
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Creation Date</label>
                  <input
                    type="date"
                    value={state.quoteDate}
                    onChange={(e) => handleTextChange('quoteDate', e.target.value)}
                    className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs font-bold text-gray-900 focus:outline-none focus:bg-white focus:border-brand-400"
                  />
                </div>

                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Validity Guarantee</label>
                  <input
                    type="date"
                    value={state.validTill}
                    onChange={(e) => handleTextChange('validTill', e.target.value)}
                    className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs font-bold text-gray-900 focus:outline-none focus:bg-white focus:border-brand-400"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Subject Title Banner</label>
                  <input
                    type="text"
                    value={state.quoteTitle}
                    onChange={(e) => handleTextChange('quoteTitle', e.target.value)}
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Specific Project Target</label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Client Reference / RFQ ID</label>
                  <input
                    type="text"
                    value={state.custRef}
                    onChange={(e) => handleTextChange('custRef', e.target.value)}
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Transit / Freight Carrier</label>
                  <input
                    type="text"
            ...
            <div className="p-6 rounded-2xl bg-white border border-gray-200 shadow-sm space-y-4 animate-fadeIn">
              <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                ...
                <span className="text-[10px] text-gray-400 font-mono">Optional high-fidelity asset overrides</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-gray-50/60 rounded-xl border border-gray-200 flex items-center gap-3 relative group">
                  <div className="w-12 h-12 rounded-lg bg-white border border-gray-200 flex items-center justify-center shrink-0 overflow-hidden relative">
                    {state.companyLogo ? (
                      <img src={state.companyLogo} alt="Company Logo" className="w-full h-full object-contain p-0.5" />
                    ) : (
                      <span className="text-[9px] font-bold text-gray-400 text-center leading-tight">No Logo</span>
                    )}
                  </div>
                  <div className="flex-1">
                    <span className="block text-xs font-bold text-gray-800">Custom Company Logo</span>
                    <span className="text-[10px] text-gray-500 block">Replaces standard text header</span>
                    <label className="mt-1 inline-block text-[10px] font-extrabold text-brand-900 bg-white border border-gray-200 px-2 py-0.5 rounded cursor-pointer hover:border-brand-400">
                      ...
                      <input
                        type="file"
                        accept="image/*"
                        onChange={(e) => handleGlobalPhotoUpload('companyLogo', e.target.files?.[0] || null)}
                        className="hidden"
                      />
                    </label>
                  </div>
                ...
                <div className="p-3 bg-gray-50/60 rounded-xl border border-gray-200 flex items-center gap-3 relative group">
                  <div className="w-12 h-12 rounded-lg bg-white border border-gray-200 flex items-center justify-center shrink-0 overflow-hidden relative">
                    {state.authSignature ? (
                      ...
                      <span className="text-[9px] font-bold text-gray-400 text-center leading-tight">No Sign</span>
                    )}
                  </div>
                  <div className="flex-1">
                    <span className="block text-xs font-bold text-gray-800">Authorized Signature</span>
                    <span className="text-[10px] text-gray-500 block">Renders transparently above footer</span>
                    <label className="mt-1 inline-block text-[10px] font-extrabold text-brand-900 bg-white border border-gray-200 px-2 py-0.5 rounded cursor-pointer hover:border-brand-400">
                      Browse File
                      <input
                        type="file"
                        accept="image/*"
                        onChange={(e) => handleGlobalPhotoUpload('authSignature', e.target.files?.[0] || null)}
                        className="hidden"
                      />
                    </label>
                  </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-gray-200 shadow-sm space-y-4">
              ...
              <div className="space-y-3">
                <h3 className="text-xs font-black text-brand-900">Billed To (Receiver Entity):</h3>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block text-[11px] font-bold text-gray-500 mb-1">Company Entity Name</label>
                    <input
                      type="text"
                      value={state.billName}
                      onChange={(e) => handleTextChange('billName', e.target.value)}
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-gray-500 mb-1">Contact Attn / Representative</label>
                    <input
                      type="text"
                      value={state.billContact}
                      onChange={(e) => handleTextChange('billContact', e.target.value)}
                ...
                <div>
                  <label className="block text-[11px] font-bold text-gray-500 mb-1">Complete Billing Address</label>
                  <textarea
                    rows={2}
                    value={state.billAddr}
                    onChange={(e) => handleTextChange('billAddr', e.target.value)}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <div>
                    <label className="block text-[11px] font-bold text-gray-500 mb-1">Phone String</label>
                    <input
                      type="text"
                      value={state.billPhone}
                      onChange={(e) => handleTextChange('billPhone', e.target.value)}
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-gray-500 mb-1">Email Endpoint</label>
                    <input
                      type="email"
                      value={state.billEmail}
                      onChange={(e) => handleTextChange('billEmail', e.target.value)}
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-gray-500 mb-1">GST State Name</label>
                    <input
                      type="text"
                      value={state.billState}
                      onChange={(e) => handleTextChange('billState', e.target.value)}
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-gray-500 mb-1">State Code Num</label>
                    <input
                      type="text"
                      value={state.billStateCode}
                      onChange={(e) => handleTextChange('billStateCode', e.target.value)}
                      placeholder="36"
              ...
              <div className="pt-3 border-t border-gray-100 flex items-center justify-between">
                ...
                <label className="inline-flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => state.updateForm({ sameAsBill: e.target.checked })}
                    className="w-4 h-4 rounded text-brand-900 focus:ring-brand-500 accent-brand-900 cursor-pointer"
                  />
                  <span className="text-xs font-bold text-brand-900 select-none">Same as Billing Address</span>
                </label>
              </div>
              ...
              {!state.sameAsBill && (
                <div className="space-y-3 pt-2 pl-4 border-l-2 border-brand-200 animate-fadeIn">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      <label className="block text-[11px] font-bold text-gray-500 mb-1">Shipping Entity Name</label>
                      <input
                        type="text"
                        value={state.shipName}
                        onChange={(e) => handleTextChange('shipName', e.target.value)}
                    ...
                    <div>
                      <label className="block text-[11px] font-bold text-gray-500 mb-1">Shipping Contact</label>
                      <input
                        type="text"
                        value={state.shipContact}
                        onChange={(e) => handleTextChange('shipContact', e.target.value)}
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-gray-500 mb-1">Complete Delivery Address</label>
                    <textarea
                      rows={2}
                      value={state.shipAddr}
                      onChange={(e) => handleTextChange('shipAddr', e.target.value)}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleTextChange('shipPhone', e.target.value)}
                        className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs text-gray-900 focus:outline-none focus:bg-white"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleTextChange('shipEmail', e.target.value)}
                        className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs text-gray-900 focus:outline-none focus:bg-white"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleTextChange('shipState', e.target.value)}
                        className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs text-gray-900 focus:outline-none focus:bg-white"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleTextChange('shipStateCode', e.target.value)}
                        className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs text-gray-900 focus:outline-none focus:bg-white text-center"
                      />
                    </div>
                  </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-gray-200 shadow-sm space-y-4">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-16 h-16 rounded-xl bg-white border border-gray-200 flex items-center justify-center shrink-0 relative overflow-hidden group/img mt-1">
                        {it.photo ? (
                          <img src={it.photo} alt="Item thumbnail" className="w-full h-full object-contain p-1" />
                        ) : (
                        ...
                        <input
                          type="file"
                          accept="image/*"
                          onChange={(e) => handleItemPhotoUpload(it.id, e.target.files?.[0] || null)}
                        ...
                        {it.photo && (
                          <button
                            onClick={() => state.updateItem(it.id, 'photo', null)}
                      ...
                      <div className="flex-1 w-full space-y-2">
                        <textarea
                          ...
                          onChange={(e) => state.updateItem(it.id, 'description', e.target.value)}
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                          <div>
                            <input
                              ...
                              value={it.hsn}
                              onChange={(e) => state.updateItem(it.id, 'hsn', e.target.value)}
                          ...
                          <div>
                            <div className="relative">
                              ...
                              <input
                                ...
                                min="1"
                                value={it.qty}
                                onChange={(e) => state.updateItem(it.id, 'qty', parseFloat(e.target.value) || 1)}
                          ...
                          <div>
                            <div className="relative">
                              ...
                              <input
                                ...
                                step="0.01"
                                value={it.rate}
                                onChange={(e) => state.updateItem(it.id, 'rate', parseFloat(e.target.value) || 0)}
                          ...
                          <div>
                            <select
                              value={it.tax}
                              onChange={(e) => state.updateItem(it.id, 'tax', parseFloat(e.target.value))}
                      ...
                      <div className="flex sm:flex-col items-end justify-between w-full sm:w-auto shrink-0 pt-2 sm:pt-1 pl-1">
                        <div className="text-right">
                          <span className="text-[9px] font-bold text-gray-400 block uppercase">Amount</span>
                        ...
                        >
                          <span className="text-xs font-bold block sm:hidden">Remove Row</span>
                          <span className="hidden sm:block font-black text-sm">&times;</span>
                        </button>
                      </div>
                    </div>
                  );
              ...
              >
                <Plus className="w-4 h-4 text-brand-700" /> Insert Automation Line Row
              </button>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-gray-200 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Freight Transport Class</label>
                  <select
                    value={state.freightType}
                    onChange={(e) => state.updateForm({ freightType: e.target.value as any })}
                  ...
                  >
                    ...
                    <option value="custom">Custom configured numeric amount</option>
                  </select>
                </div>

                {state.freightType === 'custom' && (
                  <div className="animate-fadeIn">
                    <label className="block text-xs font-bold text-brand-900 mb-1">Freight Target Sum (₹)</label>
                    <input
                      type="number"
                      min="0"
                      value={state.freightAmt}
                      onChange={(e) => handleNumChange('freightAmt', parseFloat(e.target.value) || 0)}
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Installation Mandate</label>
                  <select
                    value={state.instType}
                    onChange={(e) => state.updateForm({ instType: e.target.value as any })}
                    className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs font-bold text-gray-800 focus:outline-none focus:bg-white cursor-pointer"
                  >
                    <option value="extra">Extra on per-diem site terms</option>
                    <option value="included">Included in product rate sum</option>
                  </select>
                </div>
              </div>

              <div className="pt-2">
                <label className="block text-xs font-bold text-gray-600 mb-2">GST Inter/Intra Sovereignty Class</label>

                <div className="grid grid-cols-2 gap-3 max-w-md">
                  <label
                    className={`p-3 rounded-xl border flex items-center gap-3 cursor-pointer transition-all ${state.taxType === 'igst'
                  ...
                  >
                    ...
                    />
                    <div>
                      <span className="block font-black text-xs text-brand-900 leading-tight">IGST Full Slab</span>
                      <span className="text-[10px] text-gray-400 font-medium">Inter-state delivery</span>
                    </div>
                  </label>

                  <label
                    className={`p-3 rounded-xl border flex items-center gap-3 cursor-pointer transition-all ${state.taxType === 'cgst'
                        ? 'bg-brand-50 border-brand-300 shadow-sm'
                        : 'bg-white border-gray-200 hover:border-gray-300'
                      }`}
                  >
                    ...
                    />
                    <div>
                      <span className="block font-black text-xs text-brand-900 leading-tight">CGST + SGST Split</span>
                      <span className="text-[10px] text-gray-400 font-medium">Intra-state (Uttarakhand)</span>
                    </div>
                  </label>
                </div>
              </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-gray-200 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Standard Payment Expectation</label>
                  <input
                    type="text"
                    value={state.payTerms}
                    onChange={(e) => handleTextChange('payTerms', e.target.value)}
                    className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs text-gray-900 focus:outline-none focus:bg-white"
                  />
                </div>

                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Estimated Dispatch Velocity</label>
                  <input
                    type="text"
                    value={state.delivTime}
                    onChange={(e) => handleTextChange('delivTime', e.target.value)}
                    className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs text-gray-900 focus:outline-none focus:bg-white"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Commercial Instrument Warranty</label>
                  <input
                    type="text"
                    value={state.warranty}
                    onChange={(e) => handleTextChange('warranty', e.target.value)}
                    className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs text-gray-900 focus:outline-none focus:bg-white"
                  />
                </div>

                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Warranty Term Commences On</label>
                  <input
                    type="text"
                    value={state.warrantyStart}
                    onChange={(e) => handleTextChange('warrantyStart', e.target.value)}
                    className="w-full px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 text-xs text-gray-900 focus:outline-none focus:bg-white"
                  />
                </div>
              </div>
      ...
      <div className="lg:col-span-1 space-y-6 sticky top-20">
        ...
        <div className="p-6 rounded-2xl bg-white border-2 border-brand-900 shadow-md relative overflow-hidden">
          ...
          <h3 className="font-black text-xs text-brand-900 uppercase tracking-widest mb-4 flex items-center justify-between">
            ...
            <span className="text-[10px] text-gray-400 font-mono lowercase">实时核算</span>
          </h3>
          ...
          <div className="space-y-2.5 font-sans divide-y divide-gray-100/80">
            ...
            {state.taxType === 'igst' ? (
              <div className="flex justify-between text-xs pt-2">
                <span className="text-gray-500 font-medium">IGST Full Slab</span>
                <span className="font-bold text-rose-700 font-mono">
                  ₹{calculatedTaxSum.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                </span>
              </div>
            ) : (
              <>
                <div className="flex justify-between text-xs pt-2">
                  <span className="text-gray-500 font-medium">CGST Central Portion</span>
                  <span className="font-bold text-amber-700 font-mono">
                    ₹{(calculatedTaxSum / 2).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                  </span>
                </div>
                <div className="flex justify-between text-xs pt-2">
                  <span className="text-gray-500 font-medium">SGST State Portion</span>
                  <span className="font-bold text-amber-700 font-mono">
                    ₹{(calculatedTaxSum / 2).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                  </span>
                </div>
            ...
            {state.freightType === 'custom' && state.freightAmt > 0 && (
              <div className="flex justify-between text-xs pt-2">
                <span className="text-gray-500 font-medium">Auxiliary Config Freight</span>
                <span className="font-bold text-brand-700 font-mono">
                  ₹{state.freightAmt.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                </span>
              </div>
            )}
            ...
            <div className="flex justify-between items-baseline pt-3 mt-2">
              ...
              <span className="font-black text-xl text-brand-900 font-mono tracking-tight">
                ₹{(grandTotal + (state.freightType === 'custom' ? state.freightAmt : 0)).toLocaleString('en-IN', {
          ...
          <div className="pt-5 mt-4 border-t border-gray-100 space-y-2.5">
            ...
            >
              {savingHistory ? (
                ...
                <>
                  <Archive className="w-4 h-4 text-brand-700" /> Save to PostgreSQL DB Archive
                </>
              )}
            </button>
          </div>
